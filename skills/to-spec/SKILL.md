...
This skill takes the current conversation context and codebase understanding and produces a spec. Do NOT interview the user — just synthesize what you already know. Most often the conversation is a `grill-with-docs` session; a `wayfinder` map collapses into a spec here too, its decisions becoming the buildable plan.
